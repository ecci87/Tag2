const state = {
  ...
  maskEditor: {
    ...
    batchBaseCanvases: {},
    historySessionPaths: [],
    selectionBeforePreviewSwitch: null,
    loading: false,
    saving: false,
    savePromise: null,
    pendingResume: null,
